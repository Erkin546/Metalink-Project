...
const totalSliderVisibleItems = Number(getComputedStyle(currentSlider).getPropertyValue
("--slider-item"));
...
if( dontHaveExtraItem){
    slideNextBtn.setAttribute ("disabled", "");  
    slidePrevtBtn.setAttribute ("disabled", "");  
}
